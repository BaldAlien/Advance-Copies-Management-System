  ...
  <div id="settlement">
    ...
    <div id="container">
      ...
      >
        ...
        <el-table-column prop="points" label="单价（分/本）"> </el-table-column>
        <el-table-column prop="count" label="数量"> </el-table-column>
        <el-table-column prop="total_price" label="所需积分"> </el-table-column>
      </el-table>
    </div>
    <div id="footer">
      <div id="sum">
        <span class="counts">共 {{ count }} 件，</span> 合计：
        <span class="price"> {{ priceSum }} 积分</span>
      </div>
      <div id="pay-wrapper">
        ...
        .then((res) => {
          if (res.code === 0) {
            ...
            for (let item of this.tableData) {
              item.total_price = item.points * item.count;
            }
          } else {
